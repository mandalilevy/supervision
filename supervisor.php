                    ...
                    <div class="login-space">
                        ...
                        <div class="sign-up-form">
                          <form action="" method="post">
                            <div class="group"> <label class="label">Supervisor Name</label> <input  type="text" name="sid" class="input" placeholder="Enter Your Name" required=""> </div>
                            <div class="group"> <label  class="label">Supervisor Contacts</label> <input type="number" name="name" class="input" placeholder="Enter Your Contacts"  required=""> </div>
                            <div class="group"> <label  class="label">Organization/Institution/Company</label> <input type="text" name="comp" class="input" placeholder="Enter Your Company"  required=""> </div>
                            <div class="group"> <label class="label">Supervisor Username</label> <input  name="cont" type="text" class="input"  placeholder="Enter Your Username" required=""> </div>
...
$ch ="SELECT * FROM `csuper` WHERE username='".$_POST['cont']."'";
...
$qr ="INSERT INTO `csuper`(`name`, `cont`, `comp`,`username`, `pass`) VALUES ('".$_POST['sid']."','".$_POST['name']."','".$_POST['comp']."','".$_POST['cont']."','".$_POST['pass']."')";
